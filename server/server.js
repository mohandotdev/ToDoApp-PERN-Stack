...
app.post('/signup', async(req,res)=>{
    ...
    try{
        const signUp = await pool.query(`INSERT INTO users (email,hashed_password) VALUES($1, $2)`,[email,hasedPassword])
...
app.post('/login', async(req,res)=>{
    ...
    try{
        ...
        if(success){
            ...
            res.json({ detail: "Login Failed :( Please check you Credential" });
        }
    }
    catch(err){
        console.error(err)
